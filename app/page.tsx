...
export const metadata: Metadata = {
  ...
  description: 'Analyze any YouTube channel for free with Tubefission. No login required. Get AI-powered insights, viral trend discovery, and competitor analysis. Try it now!',
  keywords: [
    'youtube analytics',
