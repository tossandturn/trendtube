...
export const metadata: Metadata = {
  title: '🔍 YouTube SEO Tool 2026 | Optimize Videos | Tubefission',
  ...
  keywords: 'youtube seo tool, youtube video optimizer, youtube tag generator, youtube title optimizer, youtube seo 2026',
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: '🔍 YouTube SEO Tool 2026 | Tubefission',
      },
    ],
  },
  twitter: {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <article className="max-w-3xl mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold mb-6">YouTube SEO Best Practices for 2026</h2>
