...
const EXTENDED_KEYWORDS: Record<string, { relevance: number; route: string }> = {
  ...
  'Music': { relevance: 90, route: '/music' },
  'Education': { relevance: 88, route: '/education' },
  'Vlog': { relevance: 85, route: '/vlog' },
  'Review': { relevance: 82, route: '/review' },
  'Comedy': { relevance: 80, route: '/comedy' },
  'Sports': { relevance: 78, route: '/sports' },
  'Fitness': { relevance: 75, route: '/fitness' },
  'Food': { relevance: 72, route: '/food' },
  'Travel': { relevance: 70, route: '/travel' },
  'Fashion': { relevance: 68, route: '/fashion' },
  'Beauty': { relevance: 65, route: '/beauty' },
  'DIY': { relevance: 62, route: '/diy' },
